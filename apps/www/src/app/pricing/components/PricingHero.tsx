      ...
      <Container>
        <div className="relative max-w-4xl mx-auto text-center z-10">
          ...
          >
            ...
            <span className="font-medium">Optimized for Scale</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-purple-400">Transparent Pricing</span>
          </motion.h1>
          ...
          >
            Xtopay gives you full control over how you process payments —
            from mobile money to cards — without hidden fees or rigid plans.
            Enjoy flexible, usage-based pricing tailored to how you grow.
          </motion.p>
        </div>
      </Container>
    </section>
